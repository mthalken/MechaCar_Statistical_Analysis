...
# Read in data
mecha_data <- read.csv('data/MechaCar_mpg.csv', check.names = F,stringsAsFactors = F)

# Find the linear regression of the 6 variables
...
# Read in data
suspension_data <- read.csv('data/Suspension_coil.csv', check.names = F,stringsAsFactors = F)
